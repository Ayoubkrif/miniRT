...
/*   Updated: 2025/07/05 09:54:34 by cbordeau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rgb	diffuse_color(t_phong phong, t_light light)
{
	...
	return (color_mul((t_rgb){light.color.r, light.color.g, light.color.b}, (t_rgb){kd, kd, kd}));
}
...
t_rgb	specular_color(t_phong phong, t_light light)
{
	...
	return (color_mul((t_rgb){light.color.r, light.color.g, light.color.b},
				(t_rgb){ks, ks, ks}));
}
